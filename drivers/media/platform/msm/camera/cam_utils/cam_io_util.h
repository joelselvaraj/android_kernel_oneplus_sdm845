...
#define cam_io_w_debug(base, val, addr, comment, args...) {\
	u32 reg = addr - base; \
	CAMSS_DEBUG("cam_io_w: addr - 0x%x, base - 0x%x, reg - 0x%x, val - 0x%x | " comment, addr, base, reg, val, ##args); \
	cam_io_w(val, addr); \
}

#define cam_io_w_mb_debug(base, val, addr, comment, args...) {\
	u32 reg = addr - base; \
	CAMSS_DEBUG("cam_io_w_mb: addr - 0x%x, base - 0x%x, reg - 0x%x, val - 0x%x | " comment, addr, base, reg, val, ##args); \
...
#define cam_io_r_debug(base, addr, comment, args...) ({\
	...
	CAMSS_DEBUG("cam_io_r: addr - 0x%x, base - 0x%x, reg - 0x%x, val - 0x%x | " comment, addr, base, reg, val, ##args); \
	val; \
})
...
#define cam_io_r_mb_debug(base, addr, comment, args...) ({\
	...
	CAMSS_DEBUG("cam_io_r_mb: addr - 0x%x, base - 0x%x, reg - 0x%x, val - 0x%x | " comment, addr, base, reg, val, ##args); \
	val; \
})
